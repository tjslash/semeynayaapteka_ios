//
//  EListDrugsViewController.swift
//  TvoyaApteka
//
...
class EListDrugsViewController: BaseViewController {
    ...
    let viewModel: EListDrugsViewModel
    private let bag = DisposeBag()
    
    public weak var delegate: ListDrugsViewControllerDelegate?
    
    init(viewModel: EListDrugsViewModel) {
...
// MARK: - UITableView
extension EListDrugsViewController: UIScrollViewDelegate {
...
// MARK: - UITableView
extension EListDrugsViewController: UITableViewDataSource, UITableViewDelegate {
